...
#define FSM_SCENE_VBAT_LEVEL_1     BIT(1)
#define FSM_SCENE_VBAT_LEVEL_2     BIT(2)
#define FSM_SCENE_VBAT_LEVEL_3     BIT(3)
#define FSM_SCENE_VBAT_LEVEL_4     BIT(4)
