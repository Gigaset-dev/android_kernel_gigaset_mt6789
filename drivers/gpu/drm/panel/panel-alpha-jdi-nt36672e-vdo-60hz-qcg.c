...
#endif
//prize add by yubo for lcd hardware info 20240709 start
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
#include "../../../misc/mediatek/prize/hardware_info/hardware_info.h"
extern struct hardware_info current_lcm_info;
#endif
//prize add by yubo for lcd hardware info 20240709 end
...
static int jdi_probe(struct mipi_dsi_device *dsi)
{
	...
	pr_info("%s- qcg,nt36672e,vdo,60hz\n", __func__);
	pr_err("gezi %s---------------------------%d\n", __func__,__LINE__);
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
    strcpy(current_lcm_info.chip,"ICNL9911C");
	strcpy(current_lcm_info.id,"0x55");
...
static const struct of_device_id jdi_of_match[] = {
	{
	    .compatible = "qcg,nt36672e,vdo,60hz",
	},
	{}
};
...
static struct mipi_dsi_driver jdi_driver = {
	...
	.remove = jdi_remove,
	.driver = {
		.name = "panel-jdi-nt36672e-vdo-60hz-qcg",
		.owner = THIS_MODULE,
