...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx,0xB1,0x00,0x64,0x30,0x30,0x44,0x09,0x22,0x22,0x71,0xF1,0x54,0x5E);
	lcm_dcs_write_seq_static(ctx,0xB2,0x00,0x80,0x00,0x7F,0x0A,0x0E,0x30,0x4D,0x01,0x01);
	lcm_dcs_write_seq_static(ctx,0xB4,0x00,0xFF,0x02,0x40,0x02,0x40,0x00,0x00,0x06,0x00,0x01,0x02,0x00,0x0F,0x01,0x02,0x05,0x20,0x00,0x04,0x44,0x02,0x40,0x02,0x40,0x00,0x00,0x06,0x00,0x01,0x02,0x00,0x0F,0x01,0x02,0x05,0x00,0x00,0x04,0x44);
	lcm_dcs_write_seq_static(ctx,0xD3,0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x32,0x10,0x09,0x00,0x09,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x11,0x02,0x02,0x03,0x00,0x00,0x00,0x0A,0x08);
	msleep(5);
	lcm_dcs_write_seq_static(ctx,0xD5,0x18,0x18,0x18,0x18,0x21,0x20,0x18,0x18,0x19,0x19,0x19,0x19,0x18,0x18,0x18,0x18,0x03,0x02,0x01,0x00,0x30,0x30,0x31,0x31,0x32,0x32,0x18,0x18,0x18,0x18,0x40,0x40);
	msleep(5);
	lcm_dcs_write_seq_static(ctx,0xD6,0x18,0x18,0x18,0x18,0x20,0x21,0x19,0x19,0x18,0x18,0x19,0x19,0x18,0x18,0x18,0x18,0x00,0x01,0x02,0x03,0x30,0x30,0x31,0x31,0x32,0x32,0x18,0x18,0x18,0x18,0x40,0x40);
	msleep(5);
	lcm_dcs_write_seq_static(ctx,0xD8,0x0A,0xBE,0xFA,0xA0,0x0A,0xBE,0xFA,0xA0,0x0A,0xBE,0xFA,0xA0,0x0A,0xBE,0xFA,0xA0,0x0F,0xFF,0xFF,0xE0,0x0F,0xFF,0xFF,0xE0,0x0F,0xFF,0xFF,0xE0,0x0F,0xFF,0xFF,0xE0,0x0F,0xFF,0xFF,0xE0,0x0F,0xFF,0xFF,0xE0,0x0F,0xFF,0xFF,0xE0,0x0F,0xFF,0xFF,0xE0);
	lcm_dcs_write_seq_static(ctx,0xE0,0x00,0x05,0x06,0x2F,0x30,0x3F,0x18,0x3F,0x09,0x0D,0x0C,0x0F,0x11,0x10,0x11,0x13,0x17,0x08,0x18,0x08,0x1E,0x00,0x05,0x06,0x2F,0x30,0x3F,0x18,0x3F,0x09,0x0D,0x0C,0x0F,0x11,0x10,0x11,0x13,0x17,0x08,0x18,0x08,0x1E);
	msleep(5);
	lcm_dcs_write_seq_static(ctx,0xB6,0x2E,0x2E);
	lcm_dcs_write_seq_static(ctx,0xCC,0x08);
	lcm_dcs_write_seq_static(ctx,0xC0,0x01,0x91);
...
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
    strcpy(current_lcm_info.chip,"hx8399");
    strcpy(current_lcm_info.vendor,"boe");
    sprintf(current_lcm_info.id,"0x%02x",0x02);
    strcpy(current_lcm_info.more,"1080*1920");
#endif
	return ret;
}
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel_hx8399_fhd_dsi_vdo_boe",
		.owner = THIS_MODULE,
...
MODULE_DESCRIPTION("sc hx8399 VDO LCD Panel Driver");
