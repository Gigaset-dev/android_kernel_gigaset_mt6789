...
FM_OPTS += MODULE_NAME=$(MODULE_NAME) CFG_BUILD_CONNAC2=$(BUILD_CONNAC2) CFG_FM_CHIP_ID=$(FM_CHIP_ID) CFG_FM_CHIP=$(FM_CHIP) CFG_FM_PLAT=$(FM_PLAT) CFG_LEGACY_BUILD=$(LEGACY_BUILD)
