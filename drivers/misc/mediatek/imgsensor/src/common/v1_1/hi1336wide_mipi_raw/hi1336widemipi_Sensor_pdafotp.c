...
//#include "hi1336wide_mipi_raw_Sensor.h"

#define PFX "HI1336WIDE_pdafotp"
...
#define HI1336WIDE_EEPROM_READ_ID  0xA2
#define HI1336WIDE_EEPROM_WRITE_ID   0xA3
#define HI1336WIDE_I2C_SPEED        100  
#define HI1336WIDE_MAX_OFFSET		0xFFFF
...
BYTE hi1336wide_eeprom_data[DATA_SIZE]= {0};
...
bool getPDAFCalDataFromFile(void)
{
   ...
   {
//	 if( sys_read(fd, (char *)&hi1336wide_eeprom_data[0], 1372) )
 	if( sys_read(fd, (char *)&hi1336wide_eeprom_data[0], 1404) )
     {
...
bool read_hi1336wide_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size)
{
 	bool Flag;
	addr = 0x0800;
	size = 1404;
 	...
 	if( Flag )  memcpy( data, hi1336wide_eeprom_data, size );
