 ...
 * Setting version:
 * ------------
 *   update full pd setting for OV64B40CGMSEB_03B
...
#define PFX "OV64B40CGMS_camera_sensor"
...
#include "ov64b40cgms_mipi_raw.h"
#include "ov64b40cgms_Sensor_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B40CGMS_SENSOR_ID,
...
static kal_uint16 ov64b40cgms_table_write_cmos_sensor(
...
static void write_sensor_CT_QSC(void)
{
        ...
        {
                ov64b40cgms_table_write_cmos_sensor(ov64b_QSC_CT_setting,
...
static void write_sensor_OVPD_QSC(void)
{
        ...
        {
                ov64b40cgms_table_write_cmos_sensor(ov64b_QSC_OVPD_setting,
...
static void sensor_init(void)
{
	...
	mdelay(10);
	LOG_INF("sensor_init\n");
	ov64b40cgms_table_write_cmos_sensor(
		addr_data_pair_init_ov64b40cgms,
		sizeof(addr_data_pair_init_ov64b40cgms) / sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	...
	ov64b40cgms_table_write_cmos_sensor(
		addr_data_pair_preview_ov64b40cgms,
		sizeof(addr_data_pair_preview_ov64b40cgms) / sizeof(kal_uint16));
}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov64b40cgms_table_write_cmos_sensor(
		addr_data_pair_capture_ov64b40cgms,
		sizeof(addr_data_pair_capture_ov64b40cgms) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	ov64b40cgms_table_write_cmos_sensor(
		addr_data_pair_video_ov64b40cgms,
		sizeof(addr_data_pair_video_ov64b40cgms) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	...
	ov64b40cgms_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov64b40cgms,
		sizeof(addr_data_pair_hs_video_ov64b40cgms) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	ov64b40cgms_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov64b40cgms,
		sizeof(addr_data_pair_slim_video_ov64b40cgms) /
		sizeof(kal_uint16));
}
...
{
  LOG_INF("E\n");
  ov64b40cgms_table_write_cmos_sensor(addr_data_pair_custom1_ov64b40cgms,
		sizeof(addr_data_pair_custom1_ov64b40cgms) / sizeof(kal_uint16));
}	/*	custom1_setting  */

static void custom2_setting(void)
{
  LOG_INF("E\n");
  ov64b40cgms_table_write_cmos_sensor(addr_data_pair_custom2_ov64b40cgms,
		sizeof(addr_data_pair_custom2_ov64b40cgms) / sizeof(kal_uint16));
}	/*	custom2_setting  */
...
{
  LOG_INF("E\n");
  ov64b40cgms_table_write_cmos_sensor(addr_data_pair_custom3_ov64b40cgms,
		sizeof(addr_data_pair_custom3_ov64b40cgms) / sizeof(kal_uint16));
}	/*	custom3_setting  */
#if MORE_CUSTOM
static void custom4_setting(void)
{
  LOG_INF("E\n");
  ov64b40cgms_table_write_cmos_sensor(addr_data_pair_custom4_ov64b40cgms,
		sizeof(addr_data_pair_custom4_ov64b40cgms) / sizeof(kal_uint16));
}	/*	custom4_setting  */
static void custom5_setting(void)
{
  LOG_INF("E\n");
  ov64b40cgms_table_write_cmos_sensor(addr_data_pair_custom5_ov64b40cgms,
		sizeof(addr_data_pair_custom5_ov64b40cgms) / sizeof(kal_uint16));
}	/*	custom5_setting  */
#endif
...
/*  drv */
	...
	{
        LOG_INF("varifiy gms sucess\n");
	}else{
        LOG_INF("varifiy gms failed\n");
		*sensor_id = 0xFFFFFFFF;
        return ERROR_SENSOR_CONNECT_FAIL;
	}
/*  drv */
...
UINT32 OV64B40CGMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
