...
//prize add by huarui, end
	...
	{
		SENSOR_DRVNAME_IMX481LH_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{AVDD, Vol_1800, 0},
...
//drv add by lipengpeng 20231007 start 
	...
	{
		SENSOR_DRVNAME_IMX350MAIN_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{AVDD, Vol_2800, 0},
...
#endif
#if defined(IMX616GM_MIPI_RAW)
		{
			SENSOR_DRVNAME_IMX616GMS_MIPI_RAW,
			{
				{RST, Vol_Low, 1},
				{AVDD, Vol_2900, 0},
				{DVDD, Vol_1100, 0},
...
//prize add by linchong 20220609 start
	...
	{
		SENSOR_DRVNAME_GC08A8WIDE_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
...
#if defined(OV08D10NIGHT_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV08D10NIGHT_MIPI_RAW,
		{
			{RST, Vol_Low, 0},
			{DOVDD, Vol_1800, 1},
			{AVDD, Vol_2800, 1},
...
//drv add by lipengpeng 20230516 start 
	...
	{
		SENSOR_DRVNAME_OV64B40C_MIPI_RAW,
		{
			{RST, Vol_Low, 3},
			{SensorMCLK, Vol_High, 0},
			{DOVDD, Vol_1800, 0},
...
//drv add by lipengpeng 20230516 end 
	...
	{
		SENSOR_DRVNAME_OV02A10MACRO_MIPI_RAW,
		{
			{PDN, Vol_Low, 1 },
			{PDN, Vol_High, 1 },
			{DOVDD, Vol_1800, 0},
...
#endif
#if defined(S5KGN5SP_MIPI_RAW)
	{
		SENSOR_DRVNAME_S5KGN5SP_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 1},
...
#endif
#if defined(OV50H40_MIPI_RAW)
	{
		SENSOR_DRVNAME_OV50H40_MIPI_RAW,
		{
			{PDN, Vol_Low, 0},
			{RST, Vol_Low, 1},
			{SensorMCLK, Vol_High, 1},
