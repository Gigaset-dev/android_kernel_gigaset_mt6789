...
#define DEVICE_VERSION_OVA0B40Q    "ova0b40"
...
//static BYTE ova0b40_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };	//micheal
#if 0	//micheal
static kal_uint16 read_ova0b40_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
...
static void read_ova0b40_module_data(UINT32 sensor_id)
{
// ova0b40_common_data
// length   : 64
...
// inf      : [34 ~ 35]
	...
	memset(ova0b40_common_data, 0,sizeof(ova0b40_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		ova0b40_common_data[8 + idx] = read_ova0b40_eeprom_module(sn_starAddr + idx);
	}

	//macro
	ova0b40_common_data[28] = read_ova0b40_eeprom_module(macAddr_lsb);
	ova0b40_common_data[29] = read_ova0b40_eeprom_module(macAddr_msb);
	//inf
	ova0b40_common_data[34] = read_ova0b40_eeprom_module(infAddr_lsb);
	ova0b40_common_data[35] = read_ova0b40_eeprom_module(infAddr_msb);
	//module id
	ova0b40_common_data[0] = read_ova0b40_eeprom_module(moduleAddr);
	ova0b40_common_data[1] = read_ova0b40_eeprom_module(moduleAddr + 1);
	//sensor id
	ova0b40_common_data[2] = read_ova0b40_eeprom_module(sensorAddr);
	ova0b40_common_data[3] = read_ova0b40_eeprom_module(sensorAddr + 1);
	//lensid
	ova0b40_common_data[4] = read_ova0b40_eeprom_module(lensAddr);
	ova0b40_common_data[5] = read_ova0b40_eeprom_module(lensAddr + 1);
	//vcm
	ova0b40_common_data[6] = read_ova0b40_eeprom_module(vcmAddr);
	ova0b40_common_data[7] = read_ova0b40_eeprom_module(vcmAddr + 1);
	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
	{
		pr_debug("cam data: %02x %02x %02x %02x\n",
		       ova0b40_common_data[idx],
		       ova0b40_common_data[idx + 1],
		       ova0b40_common_data[idx + 2],
		       ova0b40_common_data[idx + 3]);
	}
}
#endif	//micheal
            ...
            *sensor_id = ((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c));
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if (deviceInfo_register_value == 0x00) {
                    //register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION_OVA0B40Q, imgsensor_info.module_id);	//micheal
                    deviceInfo_register_value=0x01;
                }
                //read_ova0b40_module_data(*sensor_id);		//micheal
                return ERROR_NONE;
            }
...
//drv add by lipengpeng 20240201  end
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            sensor_id = ((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c));
				printk("open ova0b40 sensor_id=0x%x\n",sensor_id);
            if (sensor_id == imgsensor_info.sensor_id) {
                pr_info("i2c write id: 0x%x, sensor id: 0x%x\n",
                    imgsensor.i2c_write_id, sensor_id);
                break;
...
/*
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, ova0b40_common_data,
...
UINT32 OVA0B40_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    if (pfFunc != NULL)
        *pfFunc = &sensor_func;
    return ERROR_NONE;
