 ...
 * Setting version:
 * ------------
 *   update full pd setting for OV64B40CEB_03B
...
#define PFX "OV64B40C_camera_sensor"
...
#include "ov64b40c_mipi_raw.h"
#include "ov64b40c_Sensor_setting.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV64B40C_SENSOR_ID,

	.checksum_value = 0xd389b5db,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 9248,  6944,  0,  0,  9248,  6944,  2312,  1736,  0000,  0000,  2312,  1736,  0,  0,  2312,  1736},	/*custom2 dual_cam*/	
#if MORE_CUSTOM
...
static kal_uint16 ov64b40c_table_write_cmos_sensor(
...
static __maybe_unused void write_sensor_CT_QSC(void)
{
        if(read_eeprom_sensor(0x2A6F) == 1)//crosstalk Flag valid
        {
                ov64b40c_table_write_cmos_sensor(ov64b_QSC_CT_setting,
...
static void write_sensor_OVPD_QSC(void)
{
        ...
        {
                ov64b40c_table_write_cmos_sensor(ov64b_QSC_OVPD_setting,
...
static void sensor_init(void)
{
	...
	mdelay(10);
	LOG_INF("sensor_init\n");
	ov64b40c_table_write_cmos_sensor(
		addr_data_pair_init_ov64b40c,
		sizeof(addr_data_pair_init_ov64b40c) / sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	...
	ov64b40c_table_write_cmos_sensor(
		addr_data_pair_preview_ov64b40c,
		sizeof(addr_data_pair_preview_ov64b40c) / sizeof(kal_uint16));
}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov64b40c_table_write_cmos_sensor(
		addr_data_pair_capture_ov64b40c,
		sizeof(addr_data_pair_capture_ov64b40c) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	ov64b40c_table_write_cmos_sensor(
		addr_data_pair_video_ov64b40c,
		sizeof(addr_data_pair_video_ov64b40c) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	...
	ov64b40c_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov64b40c,
		sizeof(addr_data_pair_hs_video_ov64b40c) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	ov64b40c_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov64b40c,
		sizeof(addr_data_pair_slim_video_ov64b40c) /
		sizeof(kal_uint16));
}
...
{
  LOG_INF("E\n");
  ov64b40c_table_write_cmos_sensor(addr_data_pair_custom1_ov64b40c,
		sizeof(addr_data_pair_custom1_ov64b40c) / sizeof(kal_uint16));
}	/*	custom1_setting  */

static void custom2_setting(void)
{
  LOG_INF("E\n");
  ov64b40c_table_write_cmos_sensor(addr_data_pair_custom2_ov64b40c,
		sizeof(addr_data_pair_custom2_ov64b40c) / sizeof(kal_uint16));
}	/*	custom2_setting  */
...
{
  LOG_INF("E\n");
  ov64b40c_table_write_cmos_sensor(addr_data_pair_custom3_ov64b40c,
		sizeof(addr_data_pair_custom3_ov64b40c) / sizeof(kal_uint16));
}	/*	custom3_setting  */
static void custom4_setting(void)
{
  LOG_INF("E\n");
  ov64b40c_table_write_cmos_sensor(addr_data_pair_custom4_ov64b40c,
		sizeof(addr_data_pair_custom4_ov64b40c) / sizeof(kal_uint16));
}	/*	custom4_setting  */
static void custom5_setting(void)
{
  LOG_INF("E\n");
  ov64b40c_table_write_cmos_sensor(addr_data_pair_custom5_ov64b40c,
		sizeof(addr_data_pair_custom5_ov64b40c) / sizeof(kal_uint16));
}	/*	custom5_setting  */
#endif
...
/*  drv */
	...
	{
        LOG_INF("varifiy mass sucess\n");
	}else{
        LOG_INF("varifiy mass failed\n");
		*sensor_id = 0xFFFFFFFF;
        return ERROR_SENSOR_CONNECT_FAIL;
	}
/*  drv */
...
UINT32 OV64B40C_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
