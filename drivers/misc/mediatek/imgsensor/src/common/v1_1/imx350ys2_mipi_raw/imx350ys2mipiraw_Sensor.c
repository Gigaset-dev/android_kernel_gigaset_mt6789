...
static void imx350_apply_SPC(void)
{
	...
	imx350ys2_read_SPC(imx350_SPC_data);
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		imx350ys2_read_DCC((kal_uint16) (*feature_data),
...
UINT32 IMX350YS2_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
