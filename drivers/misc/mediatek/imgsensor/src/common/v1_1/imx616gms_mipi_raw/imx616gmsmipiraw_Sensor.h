 ...
 * Filename:
 * ---------
 *	 IMX616GMSmipiraw_Sensor.h
 *
 ****************************************************************************/
#ifndef _IMX616GMSMIPI_SENSOR_H
#define _IMX616GMSMIPI_SENSOR_H
...
extern bool IMX616GMS_read_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
