...
#include "ova0b40gmsmipiraw_Sensor.h"
#include "ova0b40gms_Sensor_setting.h"

static DEFINE_SPINLOCK(imgsensor_drv_lock);
/*xuefei.wan@Camera.DRV add for register device info 20220817*/
//extern void register_imgsensor_deviceinfo(char *name, char *version, u8 module_id);	micheal
#define DEVICE_VERSION_OVA0B40GMSQ    "ova0b40gms"
static kal_uint8 deviceInfo_register_value = 0x00;
static kal_uint32 last_shutter = 0;
#define EEPROM_I2C_ADDR 0xA0

static struct imgsensor_info_struct imgsensor_info = {
    .sensor_id = OVA0B40GMS_SENSOR_ID,
...
//drv add by lipengpeng 20240309 start
    .hs_video = {
        ...
        .mipi_data_lp2hs_settle_dc = 85,
        .mipi_pixel_rate = 1030217143,
        .max_framerate = 1200,
    },
//drv add by lipengpeng 20240309 end 
    .slim_video = {
        .pclk = 1600000000,
        .linelength =   8400,
        .framelength = 6348,
                ...
                kal_uint16 shutter, kal_uint16 frame_length)
{
    ...
    shutter = (shutter >> 1) << 1;
    imgsensor.frame_length = (imgsensor.frame_length >> 1) << 1;
    pr_debug("OVA0B40GMSMIPIRAW shutter %d, last_shutter %d\n", shutter, last_shutter);
    if((last_shutter - 2 <= imgsensor.frame_length) && (imgsensor.frame_length <= last_shutter + 4) && (last_shutter > 0)) {
        imgsensor.frame_length = last_shutter + 6;
    }
    if (imgsensor.autoflicker_en) {
...
//static BYTE ova0b40gms_common_data[CAMERA_EEPPROM_COMDATA_LENGTH] = { 0 };	//micheal
#if 0	//micheal
static kal_uint16 read_ova0b40gms_eeprom_module(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
...
static void read_ova0b40gms_module_data(UINT32 sensor_id)
{
// ova0b40gms_common_data
// length   : 64
...
// inf      : [34 ~ 35]
	...
	memset(ova0b40gms_common_data, 0,sizeof(ova0b40gms_common_data));
	// QR
	for(idx = 0; idx < sn_length; idx++)
	{
		ova0b40gms_common_data[8 + idx] = read_ova0b40gms_eeprom_module(sn_starAddr + idx);
	}

	//macro
	ova0b40gms_common_data[28] = read_ova0b40gms_eeprom_module(macAddr_lsb);
	ova0b40gms_common_data[29] = read_ova0b40gms_eeprom_module(macAddr_msb);
	//inf
	ova0b40gms_common_data[34] = read_ova0b40gms_eeprom_module(infAddr_lsb);
	ova0b40gms_common_data[35] = read_ova0b40gms_eeprom_module(infAddr_msb);
	//module id
	ova0b40gms_common_data[0] = read_ova0b40gms_eeprom_module(moduleAddr);
	ova0b40gms_common_data[1] = read_ova0b40gms_eeprom_module(moduleAddr + 1);
	//sensor id
	ova0b40gms_common_data[2] = read_ova0b40gms_eeprom_module(sensorAddr);
	ova0b40gms_common_data[3] = read_ova0b40gms_eeprom_module(sensorAddr + 1);
	//lensid
	ova0b40gms_common_data[4] = read_ova0b40gms_eeprom_module(lensAddr);
	ova0b40gms_common_data[5] = read_ova0b40gms_eeprom_module(lensAddr + 1);
	//vcm
	ova0b40gms_common_data[6] = read_ova0b40gms_eeprom_module(vcmAddr);
	ova0b40gms_common_data[7] = read_ova0b40gms_eeprom_module(vcmAddr + 1);
	for (idx = 0; idx < CAMERA_EEPPROM_COMDATA_LENGTH; idx = idx + 4)
	{
		pr_debug("cam data: %02x %02x %02x %02x\n",
		       ova0b40gms_common_data[idx],
		       ova0b40gms_common_data[idx + 1],
		       ova0b40gms_common_data[idx + 2],
		       ova0b40gms_common_data[idx + 3]);
	}
}
#endif	//micheal
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        spin_unlock(&imgsensor_drv_lock);
        do {
            *sensor_id = ((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c))  + 1;
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
                ...
                if (deviceInfo_register_value == 0x00) {
                    //register_imgsensor_deviceinfo("Cam_r", DEVICE_VERSION_OVA0B40GMSQ, imgsensor_info.module_id);	//micheal
                    deviceInfo_register_value=0x01;
                }
                //read_ova0b40gms_module_data(*sensor_id);		//micheal
                return ERROR_NONE;
            }
...
{
    pr_debug("OVA0B40GMSMIPIRAW sensor_init E\n");
    load_init_setting();
    set_mirror_flip(imgsensor.mirror);
    pr_debug("OVA0B40GMSMIPIRAW sensor_init X\n");
}	/* sensor_init */
...
static kal_uint32 open(void)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
//drv add by lipengpeng 20240201  start	
    kal_uint32 sensor_id = 0; 
//drv add by lipengpeng 20240201  end
    pr_debug("%s +\n", __func__);
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        spin_lock(&imgsensor_drv_lock);
        imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
        ...
        do {
            sensor_id = ((read_cmos_sensor(0x300a) << 16) | (read_cmos_sensor(0x300b) << 8) | read_cmos_sensor(0x300c))  + 1;
				printk("open ova0b40gms sensor_id=0x%x\n",sensor_id);
            if (sensor_id == imgsensor_info.sensor_id) {
                pr_info("i2c write id: 0x%x, sensor id: 0x%x\n",
                    imgsensor.i2c_write_id, sensor_id);
                break;
...
{
    pr_debug("OVA0B40GMSMIPIRAW %s E\n", __func__);
    spin_lock(&imgsensor_drv_lock);
    ...
    set_mirror_flip(imgsensor.mirror);
    pr_debug("OVA0B40GMSMIPIRAW %s X\n", __func__);
    return ERROR_NONE;
} /* preview */
    ...
    UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    //uint32_t *pAeCtrls;	//micheal
    //uint32_t *pScenarios;	//micheal
...
/*
	...
	case SENSOR_FEATURE_GET_EEPROM_COMDATA:
		memcpy(feature_return_para_32, ova0b40gms_common_data,
...
UINT32 OVA0B40GMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
    if (pfFunc != NULL)
        *pfFunc = &sensor_func;
    return ERROR_NONE;
} /* OVA0B40GMS_MIPI_RAW_SensorInit */
