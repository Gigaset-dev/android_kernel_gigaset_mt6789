...
//drv add by lipengpeng 20231222 start 
	.min_gain = 64,//1x
	.max_gain = 1024,//16x
	.min_gain_iso = 100,
	.exp_step = 2,
...
//drv add by lipengpeng 20231222 end  
...
// lipengpeng for  captrue black --begin
	...
	case SENSOR_FEATURE_GET_FRAME_CTRL_INFO_BY_SCENARIO:
			...
			break;
	// lipengpeng for  captrue black --end
		...
		case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
			...
			*feature_para_len=4;
			break;
//drv add by lipengpeng 2023122 start 
		case SENSOR_FEATURE_GET_PIXEL_RATE:
			...
			break;
//drv add by lipengpeng 2023122 end 
