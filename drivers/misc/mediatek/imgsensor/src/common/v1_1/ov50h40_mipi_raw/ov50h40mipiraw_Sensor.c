 ...
 * Setting version:
 * ------------
 *   update full pd setting for OV50H40_AM04
 *------------------------------------------------------------------------------
...
#define PFX "OV50H40_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.margin = 0x58,//0x16,
	.min_shutter = 0x20,//0x08,	//min shutter
...
static kal_uint16 OV50H40_table_write_cmos_sensor(kal_uint16 *para,
						  kal_uint32 len)
{
...
static void set_dummy(void)
{
	...
	kal_uint16 yft_frame_length = 0;
	yft_frame_length = imgsensor.frame_length /4; //

	write_cmos_sensor(0x3840, (yft_frame_length >> 16) & 0xFF);
	write_cmos_sensor(0x380e, (yft_frame_length >> 8) & 0xFF);
	write_cmos_sensor(0x380f, (yft_frame_length)  & 0xFF);
...
static void write_shutter(kal_uint32 shutter)
{
	...
	*/
	...
	yft_shutter = shutter/4;


	write_cmos_sensor(0x3500, (yft_shutter >> 16) & 0xFF);   //need to verify
	write_cmos_sensor(0x3501, (yft_shutter >> 8) & 0xFF);
	write_cmos_sensor(0x3502, yft_shutter  & 0xFF);
...
//		read_cmos_sensor(0x481B), read_cmos_sensor(0x3812));
	if (enable) {
		write_cmos_sensor(0x3016,0xf1);
		write_cmos_sensor(0x3a88,0x44);
		write_cmos_sensor(0x3bd7,0xc8);
		write_cmos_sensor(0x3bdc,0x40);
		write_cmos_sensor(0x3be5,0x01);
		write_cmos_sensor(0x392e,0x5a);
		write_cmos_sensor(0x0100,0x01);
		mdelay(5);
		write_cmos_sensor(0x3a88,0x04);
		write_cmos_sensor(0x3bd7,0x48);
		write_cmos_sensor(0x3bdc,0x00);
		write_cmos_sensor(0x3be5,0x00);
		write_cmos_sensor(0x392e,0x0a);
...
//auroflicker:need to avoid 15fps and 30 fps
	if (imgsensor.autoflicker_en) {
		...
		write_cmos_sensor(0x3840, yft_frame_length >> 16);
		write_cmos_sensor(0x380e, yft_frame_length >> 8);
		write_cmos_sensor(0x380f, yft_frame_length & 0xFF);
		}
	} else {
	//imgsensor.frame_length = (imgsensor.frame_length  >> 1) << 1;
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_qtech_OV50H40[] = {
0x0102, 0x01,
0x6a03, 0x00,
0x0304, 0x03,
0x0305, 0x6b,
...
static void sensor_init(void)
{
	...
	OV50H40_table_write_cmos_sensor(addr_data_pair_init_qtech_OV50H40,
					sizeof(addr_data_pair_init_qtech_OV50H40) /
					sizeof(kal_uint16));
#else
	LOG_DBG("sensor_init\n");
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_qtech_OV50H40[] = {
0x0100, 0x00,
0x0304, 0x03,
0x0305, 0x6b,
0x0327, 0x0e,
...
#if MULTI_WRITE
	OV50H40_table_write_cmos_sensor(addr_data_pair_preview_qtech_OV50H40,
					sizeof(addr_data_pair_preview_qtech_OV50H40) /
					sizeof(kal_uint16));
#else
	LOG_DBG("preview_setting\n");
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_qtech_OV50H40[] = {
	0x0100, 0x00,
	0x0304, 0x03,
	0x0305, 0x6b,
	0x0327, 0x0e,
...
kal_uint16 addr_data_pair_capture_30fps_qtech_OV50H40[] = {
	0x0100, 0x00,
	0x0304, 0x03,
	0x0305, 0x6b,
	0x0327, 0x0e,
...
#if MULTI_WRITE
	if (currefps == 150) {
		OV50H40_table_write_cmos_sensor
		    (addr_data_pair_capture_15fps_qtech_OV50H40,
		     sizeof(addr_data_pair_capture_15fps_qtech_OV50H40) /
		     sizeof(kal_uint16));
	} else {
		OV50H40_table_write_cmos_sensor
		    (addr_data_pair_capture_30fps_qtech_OV50H40,
		     sizeof(addr_data_pair_capture_30fps_qtech_OV50H40) /
		     sizeof(kal_uint16));
	}
#else
	LOG_DBG("capture_setting\n");
#endif
}
...
/*
kal_uint16 addr_data_pair_video_qtech_OV50H40[] = {
	0x0304, 0x01,
	0x0305, 0x40,
	0x3501, 0x0c,
	0x3502, 0x16,
...
static void normal_video_setting(kal_uint16 currefps)
{
...
#if MULTI_WRITE
	/*OV50H40_table_write_cmos_sensor(addr_data_pair_video_qtech_OV50H40,
					sizeof(addr_data_pair_video_qtech_OV50H40) /
					sizeof(kal_uint16));*/
	...
	OV50H40_table_write_cmos_sensor(addr_data_pair_preview_qtech_OV50H40,
					...
					sizeof(kal_uint16));
#else
	LOG_DBG("normal_video_setting\n");
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_qtech_OV50H40[] = {
	0x0304, 0x01,
	0x0305, 0x40,
	0x3501, 0x04,
	0x3502, 0x2b,
...
#if MULTI_WRITE
	OV50H40_table_write_cmos_sensor(addr_data_pair_hs_video_qtech_OV50H40,
					sizeof(addr_data_pair_hs_video_qtech_OV50H40)
					/ sizeof(kal_uint16));
#else
	LOG_DBG("hs_video_setting\n");
#endif
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_qtech_OV50H40[] = {
	0x0304, 0x01,
	0x0305, 0x30,
	0x3501, 0x05,
	0x3502, 0xf2,
...
#if MULTI_WRITE
	OV50H40_table_write_cmos_sensor(addr_data_pair_slim_video_qtech_OV50H40,
					sizeof
					(addr_data_pair_slim_video_qtech_OV50H40) /
					sizeof(kal_uint16));
#else
...
kal_uint16 addr_data_pair_custom1_OV50H40_qtech[] = {
	0x0304, 0x01,
	0x0305, 0x40,
	0x3501, 0x0c,
	0x3502, 0x16,
...
static void custom1_setting(void)
{
	...
	OV50H40_table_write_cmos_sensor(addr_data_pair_custom1_OV50H40_qtech,
					sizeof(addr_data_pair_custom1_OV50H40_qtech) /
					sizeof(kal_uint16));
}
		...
		do {
				...
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {
					LOG_ERR
					    ("OV50H40_qtech i2c write id: 0x%x, sensor id: 0x%x \n",
					     imgsensor.i2c_write_id, *sensor_id);

					return ERROR_NONE;
				} else {
					LOG_ERR
					    ("OV50H40_qtech check id fail i2c write id: 0x%x, sensor id: 0x%x\n",
					     imgsensor.i2c_write_id, *sensor_id);
...
UINT32 OV50H40_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
