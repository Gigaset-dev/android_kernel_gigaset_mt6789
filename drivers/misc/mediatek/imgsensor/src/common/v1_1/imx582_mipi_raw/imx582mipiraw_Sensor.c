...
//prize add by lipengpeng 20220716 start 		
		...
		.mipi_pixel_rate = 823200000,
		.max_framerate = 300,
//prize add by lipengpeng 20220716 end		
	},

	.hs_video = { /* reg_G 1920x1080 @120fps (binning)*/
//prize add by lipengpeng 20220222 start 
		.pclk = 864000000,
		.linelength = 2912,
		.framelength = 2472,
		.startx = 0,
		...
		.max_framerate = 1200,
//prize add by lipengpeng 20220222 end 
	},
...
#ifdef DRV_IMX582_RGB_FORMAT
	.sensor_output_dataformat = DRV_IMX582_RGB_FORMAT, 
#else
...
#ifdef DRV_IMX582_MIRROR_FLIP
	.mirror = DRV_IMX582_MIRROR_FLIP,	/* mirrorflip information */
#else
...
//prize add by lipengpeng 20220716 start
	{8000, 6000, 0000, 0000, 8000, 6000, 4000, 3000,
	 0000, 0000, 4000, 3000,    0,    0, 4000, 3000}, /* video */
//prize add by lipengpeng 20220716 end
//prize add by lipengpeng 20220222 start 	 
//	{8000, 6000, 0000, 0000, 8000, 6000, 4000, 3000,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info_video = {
	...
	.i4SubBlkW = 8,
	.i4SubBlkH = 2,
	.i4PosL = {{20, 13-4}, {18, 15-4}, {22, 17-4}, {24, 19-4},
		   {20, 21-4}, {18, 23-4}, {22, 25-4}, {24, 27-4} },
	.i4PosR = {{19, 13-4}, {17, 15-4}, {21, 17-4}, {23, 19-4},
		   {19, 21-4}, {17, 23-4}, {21, 25-4}, {23, 27-4} },
	.iMirrorFlip = 0,
	.i4BlockNumX = 496,
...
static kal_uint32 close(void)
{
	LOG_INF("xxxx E\n");
//prize  add by lipengpeng 20220302 start 
//printk("00get_ttm_enable5_status()=%d\n",get_ttm_enable5_status());
//#ifdef CONFIG_PRIZE_TTM
//  printk("11get_ttm_enable5_status()=%d\n",get_ttm_enable5_status());
//   if((get_ttm_enable5_status()==1)&&(get_ttm_enable4_status()==1)&&(get_ttm_enable3_status()==1)&&(get_ttm_enable2_status()==1)&&(get_ttm_enable1_status()==1))
//   {
//	   ttm_enable5(0);
//	   ttm_enable4(0);
//	   ttm_enable3(0);
...
break;
	// prize add by zhuzhengjiang for pdaf 20200706 start
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		...
		break;
	// prize add by zhuzhengjiang for pdaf 20200706 end
