 ...
 * Filename:
 * ---------
 *	 s5k3l6gmsmipiraw_Sensor.h
 *
 ****************************************************************************/
#ifndef _S5K3L6GMSMIPI_SENSOR_H
#define _S5K3L6GMSMIPI_SENSOR_H
...
extern bool S5K3L6GMS_read_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
#endif
