...
static int initAF(void)
{
	...
	if (*g_pAF_Opened == 1) {
	    ...
	    ret = s4AF_WriteReg(0, 0x06, 0x40); //AAC2
...
/* ////////////////////////////////////////////////////////////// */
long GT9764BAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int GT9764BAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
			int *pAF_Opened)
{
