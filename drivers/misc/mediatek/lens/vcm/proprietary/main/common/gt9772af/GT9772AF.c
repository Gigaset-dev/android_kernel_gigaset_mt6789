...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4GT9772AF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long GT9772AF_Ioctl_Main(struct file *a_pstFile,
...
int GT9772AF_Release_Main(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int GT9772AF_SetI2Cclient_Main(struct i2c_client *pstAF_I2Cclient,
...
int GT9772AF_GetFileName_Main(unsigned char *pFileName)
{
