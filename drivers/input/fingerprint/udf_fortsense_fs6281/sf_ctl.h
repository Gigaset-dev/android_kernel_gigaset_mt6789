...
typedef struct spi_device fsfp_device_t;
typedef struct spi_driver fsfp_driver_t;
#define SW_BUS_NAME "spi bus"
#else
#include <linux/platform_device.h>
typedef struct platform_device fsfp_device_t;
typedef struct platform_driver fsfp_driver_t;
#define SW_BUS_NAME "platform bus"
#endif // end of #if SF_SPI_RW_EN

struct fsfp_ctl_device {
    ...
    int  (*gpio_init) (struct fsfp_ctl_device *ctl_dev);
    int  (*free_gpio) (struct fsfp_ctl_device *ctl_dev);
...
#define SF_IOC_REPORT_KEY_EVENT _IOW(SF_IOC_MAGIC, 0x09, fsfp_key_event_t *)

/* Sync 'fsfp_driver_config_t', the driver configuration. */
