...
#include "cst3548_fw.h"
#include "cst3556_fw.h"
...
//drv add by wangwei1 for hardware_info 20230628 start
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
#include "../../../misc/mediatek/prize/hardware_info/hardware_info.h"
#endif
//drv add by wangwei1 for hardware_info 20230628 end
...
static const struct hyn_chip_series hyn_6xx_fw[] = {
    {0xCACA220E,0xffffffff,"cst3530",(u8*)fw_bin_3530_m1},
    {0xCACA220C,0xffffffff,"cst3548",(u8*)fw_bin_3548_m1},//if PART_NO_EN==0 use default chip
    {0xCACA2209,0xffffffff,"cst3556",(u8*)fw_bin_3556_m1},
    {0xCACA2202,0xffffffff,"cst3640",(u8*)fw_bin_3640_m1},
    {0xCACA2201,0xffffffff,"cst6656",(u8*)fw_bin_6656_m1},
    {0xCACA2203,0xffffffff,"cst6644",(u8*)fw_bin_6644_m1},
    {0xCACA2204,0xffffffff,"cst6856",(u8*)fw_bin_6856_m1},
    {0xCACA2204,0x00000002,"cst6856",(u8*)fw_bin_6856_m2},
    //0xCACA2205 //154
    //0xCACA2206 //148E
    {0,0,NULL}
};
...
static int cst66xx_report(void)
{
    ...
    while(retry--){ //read point
		...
		//HYN_INFO("%s report_typ = 0x%2x finger_num = %d\n", __func__, report_typ, finger_num);
...
//drv add by wangwei1 for hardware_info 20230628 start
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
	sprintf(current_tp_info.chip, "CST3530");
	sprintf(current_tp_info.id,"FW_ver:0x%04x", ic->fw_ver);
