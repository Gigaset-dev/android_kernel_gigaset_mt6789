		...
		struct device_node *core_node)
{
	...
	/* Required fields */
	pdata->irq_gpio  = of_get_named_gpio_flags(core_node, "parade,irq_gpio", 0, &flag);
	printk("parade,irq_gpio=%d\n", pdata->irq_gpio);
	 ...
	 */
	pdata->rst_gpio = of_get_named_gpio_flags(core_node, "parade,rst_gpio", 0, &flag);
	printk("parade,rst_gpio=%d\n", pdata->rst_gpio);
