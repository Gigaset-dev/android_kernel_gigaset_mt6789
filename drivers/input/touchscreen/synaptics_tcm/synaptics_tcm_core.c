...
/* prize add by kangdong 20210910 start */
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
strcpy(current_tp_info.chip," S3910_FW:0x03");
...
extern struct syna_tcm_module_cb zeroflash_module;
extern struct syna_tcm_module_cb recovery_module;
extern struct syna_tcm_module_cb diag_module;
extern struct syna_tcm_module_cb device_module;
extern struct syna_tcm_module_cb testing_module;
extern struct syna_tcm_module_cb reflash_module;

extern struct completion device_remove_complete;
extern struct completion diag_remove_complete;
extern struct completion recovery_remove_complete;
extern struct completion zeroflash_remove_complete;
extern struct completion testing_remove_complete;
extern struct completion reflash_remove_complete;
static int __init syna_tcm_module_init(void)
{
	int retval;
	printk("TP module enter.\n");
	syna_tcm_add_module(&device_module, true);
	syna_tcm_add_module(&diag_module, true);
	syna_tcm_add_module(&recovery_module, true);
	syna_tcm_add_module(&zeroflash_module, true);
	syna_tcm_add_module(&testing_module, true);
	syna_tcm_add_module(&reflash_module, true);
