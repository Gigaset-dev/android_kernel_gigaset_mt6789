...
void himax_mcu_read_FW_ver(void)
{
	...
	/*drv-20240523-huangyu for TP info start */
	#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
		strcpy(current_tp_info.chip,"hx83108");
		sprintf(current_tp_info.id,"fw: %X0%X",hx_s_ic_data->vendor_display_cfg_ver,hx_s_ic_data->vendor_touch_cfg_ver);
...
{
	#if defined(HX_UID_PASSWORD)
		//char cmd[4]={0x00,0x58,0x01,0x00};
		hx_s_core_fp._register_read(0x00015800,g_password, 16);
	#endif
