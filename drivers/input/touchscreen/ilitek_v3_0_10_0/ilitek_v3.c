...
/* drv added by chenjiaxi, distinguish the TP FW of different modules, begin */
#if IS_ENABLED(CONFIG_PRIZE_HARDWARE_INFO)
#include "../../../misc/mediatek/prize/hardware_info/hardware_info.h"
#endif
/* drv added by chenjiaxi, distinguish the TP FW of different modules, end */
...
static int ilitek_get_tp_module(void)
{
	...
	/* drv added by chenjiaxi, distinguish the TP FW of different modules, begin */
	if ((strcmp(current_lcm_info.chip, "ili7807s,cphy,vdo,txd") == 0) || 
		(strcmp(current_lcm_info.chip, "ili7807s,cphy,vdo,txd,gms") == 0)) {
		return MODEL_TXD;
	} else if (strcmp(current_lcm_info.chip, "ili7807s,cphy,vdo,wcl") == 0) {
		return MODEL_DEF;
	}
	/* drv added by chenjiaxi, distinguish the TP FW of different modules, end */
	return 0;
