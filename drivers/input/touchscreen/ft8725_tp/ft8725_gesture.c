...
#if defined(CONFIG_PRIZE_COMMON_NODE)
...
/* DRV added by wangwei1 20240809, gestuer node, start */
#if defined(CONFIG_PRIZE_COMMON_NODE)
static struct fts_ts_data *ft8725_gesture_data = NULL;
extern bool gesture_status;
...
/* DRV added by wangwei1 20240809, gestuer node, start */
	...
	prize_common_node_register("GESTURE", &ft8725_double_type_func);
#endif
/* DRV modified by wangwei1 20240809, gesture mode, end */
