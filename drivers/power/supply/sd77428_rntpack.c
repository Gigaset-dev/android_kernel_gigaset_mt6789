...
const static  uint16_t  BATT_DESIGN_CAPACITY    =   1160;
const static  uint16_t  BATT_DESIGN_FCC         =   1259;
const static  uint16_t  BATT_DESIGN_CV          =   4370;
const static  uint16_t  BATT_DESIGN_EOC         =   250;
const static  uint16_t  BATT_DESIGN_EOD         =   3450;
const static  uint16_t  BATT_DESIGN_RSENSE      =   5000;
...
static uint16_t gdm_thresh_chg = 3,  gdm_thresh_dsg = 3;    // SBSA0_CONFIGDSG_CHG
...
static uint16_t FG_charge_maxdfcc = 5000;                     //SBSAB_FG_CC_DFCC_RANGE
...
static uint16_t FG_dc_max_dfcc = 5000;                     //SBSAD_FG_CC_DFCC_RANGE
...
//-----------------dfcc----------------//
static short ocv_volt_data[OCV_DATA_NUM] = { 3104, 3104, 3104, 3217, 3286, 3350, 3405, 3454, 3501, 3543, 3578, 3606, 3651, 3682, 3690, 3694, 3698, 3711, 3726, 
                                             3741, 3756, 3768, 3780, 3792, 3803, 3814, 3823, 3833, 3842, 3851, 3860, 3869, 3878, 3888, 3898, 3909, 3920, 3932, 
                                             3945, 3960, 3977, 3997, 4018, 4038, 4057, 4075, 4093, 4111, 4128, 4146, 4163, 4181, 4198, 4216, 4234, 4253, 4271, 
                                             4289, 4306, 4324, 4342, 4359, 4376, 4395, 4428};
...
static short    YAxisElement[YAxis] = {200, 1000, 2000, 3000};
...
//temp = -10 ^C
{20,24,29,36,44,55,60,64,69,73,76,80,81,82,84,85,86,87,89,91,95,97,98,99,100,100,100,100,100,100,100,100,100,100,100,100},
{61,70,78,86,92,97,98,99,99,99,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100},
{72,79,87,99,99,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100},
{99,99,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100},
//temp = 0 ^C
{11,12,14,15,17,19,22,25,31,36,42,48,50,52,54,56,56,58,61,65,69,73,76,79,83,85,88,90,93,96,99,99,100,100,100,100},
{22,26,32,39,48,59,63,67,71,75,79,82,83,84,86,87,87,89,91,93,97,98,99,99,100,100,100,100,100,100,100,100,100,100,100,100},
{40,47,56,65,74,82,85,89,93,97,98,99,99,99,99,99,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100},
{45,52,61,70,78,98,99,99,99,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100},
//temp = 20 ^C
{4,6,7,9,12,15,16,17,18,23,28,33,35,37,40,42,43,46,49,54,60,64,67,69,73,75,78,80,82,85,90,93,96,99,100,100},
{10,12,13,15,18,22,26,32,38,43,49,54,55,57,59,60,61,62,65,68,73,76,79,82,85,88,90,92,95,97,99,100,100,100,100,100},
{15,17,20,25,33,44,49,54,58,62,66,70,71,72,73,75,75,76,78,82,86,90,92,96,99,99,99,100,100,100,100,100,100,100,100,100},
{18,22,28,35,45,54,58,63,66,70,73,77,78,79,81,82,82,84,86,90,95,98,99,99,100,100,100,100,100,100,100,100,100,100,100,100},
//temp = 40 ^C
{1,2,3,5,8,10,12,14,16,18,25,30,32,33,36,38,38,41,44,50,56,60,63,66,70,72,74,77,79,82,87,90,93,98,100,100},
{3,5,6,9,11,14,16,18,23,29,34,40,43,44,47,49,50,51,55,58,64,67,70,73,77,80,81,83,86,88,94,97,99,100,100,100},
{6,8,10,12,16,21,26,31,37,43,48,53,55,56,58,59,60,61,64,67,72,75,78,80,84,87,89,91,94,97,99,100,100,100,100,100},
{7,9,12,16,21,31,36,42,47,52,56,61,62,63,65,66,67,68,70,73,77,81,83,86,90,93,96,98,99,99,100,100,100,100,100,100}
};
...
static int32_t sd77428rnt_cfg_offset(struct sd77428_data *chip)
{
    ...
    pr_info("sd77428rnt_cfg_offset reg 0x%x, slope 0x%x, zero_offset 0x%x.\n", reg_value, cadc_slope, cadc_offset);
...
static int32_t sd77428_enable_cadc(struct sd77428_data *chip)
{
    ...
    sd77428_hard_opt = 1;
    pr_info("sd77428rnt_enable_cadc.\n");
    sd77428_unlock(chip);
    // sd77428_write_word(chip,0xEB,0x003F);           //set fastwakeup th
    ...
    pr_info("sd77428rnt read sw_cadc_ctrl: 0x%x.\n", sw_cadc_ctrl);
    if (!ret)
    {
        sw_cadc_ctrl = sw_cadc_ctrl | 0x00000001;  //set sw_cadc_enable = 1, 
        pr_info("sd77428rnt pdate sw_cadc_ctrl: 0x%x.\n", sw_cadc_ctrl);
...
static int32_t sd77428_disable_cadc(struct sd77428_data *chip)
{
    ...
    uint32_t sw_cadc_ctrl = 0;
    sd77428_hard_opt = 1;
    pr_info("sd77428rnt_disable_cadc.\n");
    sd77428_unlock(chip);
    //sd77428_write_word(chip,0xEB,0x003F);
    ...
    if (!ret)
    {
        ...
        pr_info("sd77428rnt update sw_cadc_ctrl: 0x%x.\n", sw_cadc_ctrl);
...
static int32_t sd77428_disable_fastdsg(struct sd77428_data *chip)
{
    ...
    pr_info("sd77428rnt_disable_fastdsg.\n");
    sd77428_unlock(chip);
    ...
    for (retry_cnt = 0; retry_cnt < 4; ++retry_cnt)
    {
        ...
        pr_info("sd77428rnt set param_ddv default:0x%x, eod:0x%x, new:0x%x.\n", sd77428_default_ddv, BATT_DESIGN_EOD, param_ddv);
...
static int32_t sd77428_enable_fastdsg(struct sd77428_data *chip)
{
    ...
    pr_info("sd77428rnt_enable_fastdsg.\n");
    sd77428_unlock(chip);
    ...
    for (retry_cnt = 0; retry_cnt < 4; ++retry_cnt)
    {
        ...
        sd77428_read_addr(chip,0x20000818,&param_ddv);                //read param_ddv
        pr_info("sd77428rnt set param_ddv default:%d. set:%d.\n", sd77428_default_ddv, param_ddv);
...
static int32_t sd77428_power_supply_init(struct sd77428_data *chip)
{
    ...
    chip->bat_desc.name             = "sd77428_rnt";
...
int32_t sd77428rnt_chip_ok(void)
{
    return sd77428_is_ready;
}
EXPORT_SYMBOL(sd77428rnt_chip_ok);

int32_t sd77428rnt_get_remaincap(void)
{
    batt_data_t* pinfo = &g_chip_data->batt_info;
    return pinfo->batt_rc;
}
EXPORT_SYMBOL(sd77428rnt_get_remaincap);

int32_t sd77428rnt_get_soc(void)
{
    batt_data_t* pinfo = &g_chip_data->batt_info;
    return pinfo->batt_rsoc;
}
EXPORT_SYMBOL(sd77428rnt_get_soc);

int32_t sd77428rnt_get_soh(void)
{
    batt_data_t* pinfo = &g_chip_data->batt_info;
    return pinfo->batt_soh;
}
EXPORT_SYMBOL(sd77428rnt_get_soh);

int32_t sd77428rnt_get_battery_current(void)
{
    batt_data_t* pinfo = &g_chip_data->batt_info;
    return pinfo->batt_current;
}
EXPORT_SYMBOL(sd77428rnt_get_battery_current);

int32_t sd77428rnt_get_battery_voltage(void)
{
    batt_data_t* pinfo = &g_chip_data->batt_info;
    return pinfo->batt_voltage;
}
EXPORT_SYMBOL(sd77428rnt_get_battery_voltage);

int32_t sd77428rnt_get_battery_temp(void)
{
    batt_data_t* pinfo = &g_chip_data->batt_info;
    return pinfo->batt_temp;
}
EXPORT_SYMBOL(sd77428rnt_get_battery_temp);

int32_t sd77428rnt_get_battery_dfcc(void)
{
    batt_data_t* pinfo = &g_chip_data->batt_info;
    return pinfo->batt_dfcc;
}
EXPORT_SYMBOL(sd77428rnt_get_battery_dfcc);

int32_t sd77428rnt_get_battery_cc(void)
{
    batt_data_t* pinfo = &g_chip_data->batt_info;
    return pinfo->batt_cc;
}
EXPORT_SYMBOL(sd77428rnt_get_battery_cc);

struct i2c_client * sd77428rnt_get_client(void)
{
    if (g_chip_data)
...
EXPORT_SYMBOL(sd77428rnt_get_client);

int8_t sd77428rnt_get_adapter_status(void)
{
    return g_chip_data->adapter_status;
}
EXPORT_SYMBOL(sd77428rnt_get_adapter_status);
//---------------------------------------------------------------------------------------------------------------------//
...
static int32_t sd77428_init_batt_info(struct sd77428_data *chip)
{
	...
	sprintf(current_battery_info.batt1_versions,"%d",BATT_DESIGN_FCC);
	#endif
    return 0;
}
...
{   
    ...
    if (ret == 0)
    {
    batt_dbg("sd77428_rntpack vbat:%d, ibat:%05d, tbat:%d, rsoc:%03d, fcc:%d, dcap:%d, soh:%d, cycle:%d, rc:%d, dfcc:%d, cc:%d, ext_chg %d\n",
        pinfo->batt_voltage,
        pinfo->batt_current,
        pinfo->batt_temp,
        pinfo->batt_rsoc,
    ...
    if (!sd77428_is_ready)
    {
        ...
        batt_dbg("sd77428_rntpack is ready.\n");
    }
}
...
static int32_t check_reset_bank1(struct sd77428_data *chip)
{
    ...
    pr_info("sd77428rnt check BANK1 %d.\r\n", batt_rsoc);
    ...
    if (batt_rsoc == 0)
    {
        ...
        {
            pr_info("sd77428rnt clear BANK1 Failed.\r\n");
            return 1;
        }
        else
        {
            pr_info("sd77428rnt clear BANK1 Successed.\r\n");
        }
        msleep(1);
    }
    return 0;
...
static uint16_t parameters_down_level8(struct sd77428_data *chip)
{
    ...
    //set cadc trim value
    if(sd77428rnt_cfg_offset(chip) < 0)
    {
        pr_info("sd77428rnt_cfg_offset Set Failed.\r\n");
        paramdown_result += (1 << 9);
    }
    msleep(1);
...
int32_t sd77428rnt_suspend(struct device *dev)
{
    struct sd77428_data *chip  = i2c_get_clientdata(to_i2c_client(dev));
    cancel_delayed_work_sync(&chip->sd77428_work);
    pr_info("sd77428rnt is suspend\n");
    return 0;
}

int32_t sd77428rnt_resume(struct device *dev)
{
    struct sd77428_data *chip = i2c_get_clientdata(to_i2c_client(dev));
    if(true == sd77428_is_ok)
        schedule_delayed_work(&chip->sd77428_work,msecs_to_jiffies(20));
    pr_info("sd77428rnt is resume. sd77428_is_ok %d\n", sd77428_is_ok);
    return 0;
}

int32_t sd77428rnt_remove(struct i2c_client *client)
{
    ...
    cancel_delayed_work_sync(&chip->sd77428_work);
    pr_info("sd77428rnt is remove\n");

    return 0;
}

void sd77428rnt_shutdown(struct i2c_client *client)
{
    struct sd77428_data *chip = i2c_get_clientdata(client);
    ...
    // power_supply_unregister(chip->bat);
    cancel_delayed_work_sync(&chip->sd77428_work);
    pr_info("sd77428rnt is shutdown\n");
}
//---------------------------------------------------------------------------------------------------------------------//
static int32_t check_param_update(struct sd77428_data *chip)
{
    ...
    {
       pr_info("sd77428rnt Chip SBS66_DSNCAP is %d, need update params.\r\n", param_low);
       return 1;
    }
    else
    {
       pr_info("sd77428rnt Chip SBS66_DSNCAP is %d, do not need update params.\r\n", param_low);
       return 0;
    }
    return 0;
}

int32_t sd77428rnt_ic_init(struct sd77428_data *chip)
{
    int32_t ret = 0;
