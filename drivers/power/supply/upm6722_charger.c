...
//drv add by lipengpeng 20220913 start
...
//drv add by lipengpeng 20220913 end
...
static int mtk_upm6722_set_vbusovp(struct charger_device *chg_dev, u32 uV)
{
    ...
    return upm6722_set_busovp_th(upm, CHG_BYPASS_MODE, mv);
}
...
static int mtk_upm6722_set_ibusocp(struct charger_device *chg_dev, u32 uA)
{
    ...
    return upm6722_set_busocp_th(upm, CHG_BYPASS_MODE, ma);
}
...
static int mtk_upm6722_set_vbusovp_alarm(struct charger_device *chg_dev, u32 uV)
{
    ...
    ret = upm6722_set_bus_ovp_alm_th(upm, CHG_BYPASS_MODE, uV/1000);
    if (ret < 0)
        return ret;
